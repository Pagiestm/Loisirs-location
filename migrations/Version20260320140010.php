 ...
 */
final class Version20260320140010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id_user INT AUTO_INCREMENT NOT NULL, last_name VARCHAR(50) NOT NULL, first_name VARCHAR(50) NOT NULL, email VARCHAR(100) NOT NULL, phone VARCHAR(20) DEFAULT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, is_verified TINYINT DEFAULT 0 NOT NULL, verification_token VARCHAR(100) DEFAULT NULL, verification_token_expires_at DATETIME DEFAULT NULL, reset_password_token VARCHAR(100) DEFAULT NULL, reset_password_token_expires_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, id_address INT DEFAULT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), INDEX IDX_1483A5E9D3D3C6F1 (id_address), PRIMARY KEY (id_user)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE van_images (id INT AUTO_INCREMENT NOT NULL, image_name VARCHAR(255) DEFAULT NULL, caption VARCHAR(255) DEFAULT NULL, position INT NOT NULL, updated_at DATETIME DEFAULT NULL, van_id INT NOT NULL, INDEX IDX_12E43C508A128D90 (van_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE van_options (id_van_option INT AUTO_INCREMENT NOT NULL, value VARCHAR(50) NOT NULL, id_van INT NOT NULL, id_option INT NOT NULL, INDEX IDX_16CBD8B7E7753313 (id_van), INDEX IDX_16CBD8B77CB1B55D (id_option), PRIMARY KEY (id_van_option)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE vans (id_van INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, subtitle VARCHAR(50) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id_van)) DEFAULT CHARACTER SET utf8mb4');
